      ...
      <footer className="footer">
        <div className="container">
          ...
          <div className="footer-bottom">
            <p className="copyright">{footerData.copyright || '© 2024 ЮТОРС. Все права защищены.'}</p>
            <a href="https://dectitle.ru/" target="_blank" rel="noopener noreferrer" className="developer-link">
